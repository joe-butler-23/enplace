...
`mep shop --folder <folder>` hashes the file it read and, if `Shopping.md` changes before save, writes the rebuilt list to a sibling `.conflict-*.md` file instead of overwriting either version.

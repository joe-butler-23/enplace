...
const ICON_SVGS: Record<string, string> = {
  ...
  "circle-help": "<svg viewBox=\"0 0 24 24\" width=\"16\" height=\"16\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"12\" cy=\"12\" r=\"9\"></circle><path d=\"M9.1 9a3 3 0 1 1 5.5 1.8c-.9 1.2-2.6 1.5-2.6 3.2\"></path><path d=\"M12 17h.01\"></path></svg>",
